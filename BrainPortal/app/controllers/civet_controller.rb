...
class CivetController < ApplicationController
  ...
  def new
    ...
    if @task_class.has_params?
      @params  = @task_class.get_default_params(params)  # provided first time we enter the edit page
    end
    ...
    respond_to do |format|
      ...
      #format.xml  { render :xml => @params[:civet_params] }
    end
